...
var isEditing = false;
// SCSS imports
import '../../../../../styles/games/mobile-legend/mobileL-organizer.scss';
...
class MobileLOrganizer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // Admin validation
    ...
    MobileLOrganizer.prototype.uploadInstances = MobileLOrganizer.prototype.uploadInstances.bind(
      this
    );
    MobileLOrganizer.prototype.eraseTournament = MobileLOrganizer.prototype.eraseTournament.bind(
      this
    );
    MobileLOrganizer.prototype.organizerPanel = MobileLOrganizer.prototype.organizerPanel.bind(
      this
    );
    MobileLOrganizer.prototype.editTournament = MobileLOrganizer.prototype.editTournament.bind(
      this
    );
    MobileLOrganizer.prototype.navigationHandler = MobileLOrganizer.prototype.navigationHandler.bind(
      this
    );
    MobileLOrganizer.prototype.organizerButtonsHandler = MobileLOrganizer.prototype.organizerButtonsHandler.bind(
      this
    );
    MobileLOrganizer.prototype.orgForm = MobileLOrganizer.prototype.orgForm.bind(
      this
    );
    MobileLOrganizer.prototype.saveSingleInstance = MobileLOrganizer.prototype.saveSingleInstance.bind(
      this
    );
    MobileLOrganizer.prototype.unassignedDays = MobileLOrganizer.prototype.unassignedDays.bind(
      this
    );
    MobileLOrganizer.prototype.assignedDays = MobileLOrganizer.prototype.assignedDays.bind(
      this
    );
    MobileLOrganizer.prototype.updateClickedDay = MobileLOrganizer.prototype.updateClickedDay.bind(
      this
    );
    MobileLOrganizer.prototype.loadTournaments = MobileLOrganizer.prototype.loadTournaments.bind(
      this
    );
  }
    ...
    if (initialDay > 0 && initialMonthNumber > 0 && weeksDuration > 0) {
      ...
      function customDay(dayInfo) {
        ...
        panelButton.addEventListener('click', () => {
          MobileLOrganizer.prototype.organizerButtonsHandler(
            dayInfo.day,
            dayInfo
          );
        });
  ...
  orgForm() {
    //MobileLOrganizer.prototype.refreshFormPanel();
    // Local Vars
    console.log('aqui');
    ...
    function content(selectInit, updatingInstance) {
      ...
      function selectInstances(clickedInstance) {
        ...
        dayInstanceDiv.onchange = () => {
          MobileLOrganizer.prototype.relatedDayRender();
        };
      ...
      //tStartInput.onChange = ()=> {MobileLOrganizer.prototype.updatingInstance()}
      ...
      return (
        <button
          ...
          onClick={() =>
            MobileLOrganizer.prototype.saveSingleInstance(invoked)
          }>
          SAVEE
        </button>
      );
  ...
  organizerButtonsHandler(dayData, nameDayInfo) {
    ...
    if (isUpdating()) {
      ...
      MobileLOrganizer.prototype.saveSingleInstance(autoSave);
    }
  }
    ...
    switch (invoked.invoked) {
      case 'autoSave': {
        if (invoked.confirmed) {
          ...
          setTimeout(function () {
            MobileLOrganizer.prototype.updateClickedDay(invoked.nameDayObj);
          }, 15);
        } else {
          setTimeout(function () {
            MobileLOrganizer.prototype.updateClickedDay(invoked.nameDayObj);
  ...
  relatedDayRender() {
    ...
    MobileLOrganizer.prototype.unassignedDays(event.target.value);
      ...
      if (unassignedDayPanelChilds[0]) {
        ...
        for (var i = 0; i < instanceArr.length; i++) {
          ...
          if (instanceArr[i].nextInstance[0]) {
            ...
            renderCheck
              ? renderDay(MobileLOrganizer.prototype.relatedDayHandler)
              : '';
          }
        }
      }
  ...
  updateClickedDay(dayInfoObj) {
    MobileLOrganizer.prototype.refreshButtonPanel();
    this.setState({
      dayInfo: dayInfoObj,
      autoSave: true,
    });
  ...
  async eraseTournament() {
    var IDO = this.state.IDO;
    var IDT = this.state._id;
  ...
  tInfoPacketFunctions() {
    var tInfoFunctions = {
      confirmEdit: MobileLOrganizer.prototype.confirmEdit,
      editTournament: MobileLOrganizer.prototype.editTournament,
      eraseTournament: MobileLOrganizer.prototype.eraseTournament,
      startTournament: MobileLOrganizer.prototype.startTournament,
      stopTournament: MobileLOrganizer.prototype.stopTournament,
      closeInscription: MobileLOrganizer.prototype.closeInscription,
      editText: MobileLOrganizer.prototype.editText,
      loadTournaments: MobileLOrganizer.prototype.loadTournaments,
    };
    ...
    return (
      <div id={`${game}-organaizer-main-wrapper`} className='main-wrapper'>
        {htmlTemplates.classicTemplate(
          ...
          MobileLOrganizer.prototype.tInfoPacketFunctions,
          MobileLOrganizer.prototype.uploadInstances,
          MobileLOrganizer.prototype.selectInit,
          MobileLOrganizer.prototype.organizerPanel,
          MobileLOrganizer.prototype.orgForm,
          MobileLOrganizer.prototype.eraseTournament
        )}
      </div>
    );
  }
...
export default MobileLOrganizer;
