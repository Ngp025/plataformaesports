...
var isEditing = false;
// SCSS imports
import '../../../../../styles/games/gran-turismo/gt-organizer.scss';
...
class GtOrganizer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // Admin validation
    ...
    GtOrganizer.prototype.uploadInstances = GtOrganizer.prototype.uploadInstances.bind(
      this
    );
    GtOrganizer.prototype.eraseTournament = GtOrganizer.prototype.eraseTournament.bind(
      this
    );
    GtOrganizer.prototype.organizerPanel = GtOrganizer.prototype.organizerPanel.bind(
      this
    );
    GtOrganizer.prototype.editTournament = GtOrganizer.prototype.editTournament.bind(
      this
    );
    GtOrganizer.prototype.navigationHandler = GtOrganizer.prototype.navigationHandler.bind(
      this
    );
    GtOrganizer.prototype.organizerButtonsHandler = GtOrganizer.prototype.organizerButtonsHandler.bind(
      this
    );
    GtOrganizer.prototype.orgForm = GtOrganizer.prototype.orgForm.bind(this);
    GtOrganizer.prototype.saveSingleInstance = GtOrganizer.prototype.saveSingleInstance.bind(
      this
    );
    GtOrganizer.prototype.unassignedDays = GtOrganizer.prototype.unassignedDays.bind(
      this
    );
    GtOrganizer.prototype.assignedDays = GtOrganizer.prototype.assignedDays.bind(
      this
    );
    GtOrganizer.prototype.updateClickedDay = GtOrganizer.prototype.updateClickedDay.bind(
      this
    );
    GtOrganizer.prototype.loadTournaments = GtOrganizer.prototype.loadTournaments.bind(
      this
    );
  }
    ...
    if (initialDay > 0 && initialMonthNumber > 0 && weeksDuration > 0) {
      ...
      function customDay(dayInfo) {
        ...
        panelButton.addEventListener('click', () => {
          GtOrganizer.prototype.organizerButtonsHandler(dayInfo.day, dayInfo);
        });
      ...
      function createDayButton(i, month) {
        ...
        panelButton.addEventListener('click', () =>
          GtOrganizer.prototype.organizerButtonsHandler(completeDate, emptyData)
        );
        organizerPanel.appendChild(panelButton);
      }
  ...
  orgForm() {
    //GtOrganizer.prototype.refreshFormPanel();
    // Local Vars
    ...
    function content(selectInit, updatingInstance) {
      ...
      function selectInstances(clickedInstance) {
        ...
        dayInstanceDiv.onchange = () => {
          GtOrganizer.prototype.relatedDayRender();
        };
      ...
      //tStartInput.onChange = ()=> {GtOrganizer.prototype.updatingInstance()}
      ...
      return (
        <button
          ...
          onClick={() => GtOrganizer.prototype.saveSingleInstance(invoked)}>
          SAVEE
        </button>
      );
    }
  ...
  organizerButtonsHandler(dayData, nameDayInfo) {
    ...
    if (isUpdating()) {
      ...
      GtOrganizer.prototype.saveSingleInstance(autoSave);
    }
  }
    ...
    switch (invoked.invoked) {
      case 'autoSave': {
        if (invoked.confirmed) {
          ...
          setTimeout(function () {
            GtOrganizer.prototype.updateClickedDay(invoked.nameDayObj);
          }, 15);
        } else {
          setTimeout(function () {
            GtOrganizer.prototype.updateClickedDay(invoked.nameDayObj);
  ...
  relatedDayRender() {
    ...
    GtOrganizer.prototype.unassignedDays(event.target.value);
      ...
      if (unassignedDayPanelChilds[0]) {
        ...
        for (var i = 0; i < instanceArr.length; i++) {
          ...
          if (instanceArr[i].nextInstance[0]) {
            ...
            renderCheck
              ? renderDay(GtOrganizer.prototype.relatedDayHandler)
              : '';
          }
        }
      }
  ...
  updateClickedDay(dayInfoObj) {
    GtOrganizer.prototype.refreshButtonPanel();
    this.setState({
      dayInfo: dayInfoObj,
      autoSave: true,
    });
  ...
  tInfoPacketFunctions() {
    var tInfoFunctions = {
      confirmEdit: GtOrganizer.prototype.confirmEdit,
      editTournament: GtOrganizer.prototype.editTournament,
      eraseTournament: GtOrganizer.prototype.eraseTournament,
      startTournament: GtOrganizer.prototype.startTournament,
      stopTournament: GtOrganizer.prototype.stopTournament,
      closeInscription: GtOrganizer.prototype.closeInscription,
      editText: GtOrganizer.prototype.editText,
      loadTournaments: GtOrganizer.prototype.loadTournaments,
    };
    ...
    return (
      <div id={`${game}-organaizer-main-wrapper`} className='main-wrapper'>
        {htmlTemplates.classicTemplate(
          ...
          GtOrganizer.prototype.tInfoPacketFunctions,
          GtOrganizer.prototype.uploadInstances,
          GtOrganizer.prototype.selectInit,
          GtOrganizer.prototype.organizerPanel,
          GtOrganizer.prototype.orgForm,
          GtOrganizer.prototype.eraseTournament
        )}
      </div>
    );
  }
