...
// Local SCSS imports
import '../../../../../styles/games/gran-turismo/gt-tournament.scss';
...
class GtTournament extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tInfo: {
      ...
      interval: setInterval(function tCheck() {
        GtTournament.prototype.timeDataCheck();
      }, 1000),
    ...
    GtTournament.prototype.timeDataCheck = GtTournament.prototype.timeDataCheck.bind(
      this
    );
    GtTournament.prototype.supportNavHandler = GtTournament.prototype.supportNavHandler.bind(
      this
    );
  }
    ...
    if (!this.state.tInfo) {
      ...
      if (this.state.tInfo.tStart === 'cargando') {
        ...
        organizerClock.tournamentClock(
          ...
          GtTournament.prototype.clockOutput
        );
      }
    }
  }
    ...
    return (
      <div id={`${game}-tournament-main-wrapper`}>
        {htmlTemplates.classicTemplate(
          ...
          GtTournament.prototype.supportNavHandler,
