...
var isEditing = false;
// SCSS imports
import '../../../../../styles/games/league-of-legends/lol-organizer.scss';
...
class LolOrganizer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // Admin validation
    ...
    LolOrganizer.prototype.uploadInstances = LolOrganizer.prototype.uploadInstances.bind(
      this
    );
    LolOrganizer.prototype.eraseTournament = LolOrganizer.prototype.eraseTournament.bind(
      this
    );
    LolOrganizer.prototype.organizerPanel = LolOrganizer.prototype.organizerPanel.bind(
      this
    );
    LolOrganizer.prototype.editTournament = LolOrganizer.prototype.editTournament.bind(
      this
    );
    LolOrganizer.prototype.navigationHandler = LolOrganizer.prototype.navigationHandler.bind(
      this
    );
    LolOrganizer.prototype.organizerButtonsHandler = LolOrganizer.prototype.organizerButtonsHandler.bind(
      this
    );
    LolOrganizer.prototype.orgForm = LolOrganizer.prototype.orgForm.bind(this);
    LolOrganizer.prototype.saveSingleInstance = LolOrganizer.prototype.saveSingleInstance.bind(
      this
    );
    LolOrganizer.prototype.unassignedDays = LolOrganizer.prototype.unassignedDays.bind(
      this
    );
    LolOrganizer.prototype.assignedDays = LolOrganizer.prototype.assignedDays.bind(
      this
    );
    LolOrganizer.prototype.updateClickedDay = LolOrganizer.prototype.updateClickedDay.bind(
      this
    );
    LolOrganizer.prototype.loadTournaments = LolOrganizer.prototype.loadTournaments.bind(
      this
    );
  }
    ...
    if (initialDay > 0 && initialMonthNumber > 0 && weeksDuration > 0) {
      ...
      function customDay(dayInfo) {
        ...
        panelButton.addEventListener('click', () => {
          LolOrganizer.prototype.organizerButtonsHandler(dayInfo.day, dayInfo);
        });
      ...
      function createDayButton(i, month) {
        ...
        panelButton.addEventListener('click', () =>
          LolOrganizer.prototype.organizerButtonsHandler(
            completeDate,
            emptyData
          )
        );
  ...
  orgForm() {
    //LolOrganizer.prototype.refreshFormPanel();
    // Local Vars
    console.log('aqui');
    ...
    function content(selectInit, updatingInstance) {
      ...
      function selectInstances(clickedInstance) {
        ...
        dayInstanceDiv.onchange = () => {
          LolOrganizer.prototype.relatedDayRender();
        };
      ...
      //tStartInput.onChange = ()=> {LolOrganizer.prototype.updatingInstance()}
      ...
      return (
        <button
          ...
          onClick={() => LolOrganizer.prototype.saveSingleInstance(invoked)}>
          SAVEE
        </button>
      );
    }
  ...
  organizerButtonsHandler(dayData, nameDayInfo) {
    ...
    if (isUpdating()) {
      ...
      LolOrganizer.prototype.saveSingleInstance(autoSave);
    }
  }
    ...
    switch (invoked.invoked) {
      case 'autoSave': {
        if (invoked.confirmed) {
          ...
          setTimeout(function () {
            LolOrganizer.prototype.updateClickedDay(invoked.nameDayObj);
          }, 15);
        } else {
          setTimeout(function () {
            LolOrganizer.prototype.updateClickedDay(invoked.nameDayObj);
  ...
  relatedDayRender() {
    ...
    LolOrganizer.prototype.unassignedDays(event.target.value);
      ...
      if (unassignedDayPanelChilds[0]) {
        ...
        for (var i = 0; i < instanceArr.length; i++) {
          ...
          if (instanceArr[i].nextInstance[0]) {
            ...
            renderCheck
              ? renderDay(LolOrganizer.prototype.relatedDayHandler)
              : '';
          }
        }
      }
  ...
  updateClickedDay(dayInfoObj) {
    LolOrganizer.prototype.refreshButtonPanel();
    this.setState({
      dayInfo: dayInfoObj,
      autoSave: true,
    });
  ...
  tInfoPacketFunctions() {
    var tInfoFunctions = {
      confirmEdit: LolOrganizer.prototype.confirmEdit,
      editTournament: LolOrganizer.prototype.editTournament,
      eraseTournament: LolOrganizer.prototype.eraseTournament,
      startTournament: LolOrganizer.prototype.startTournament,
      stopTournament: LolOrganizer.prototype.stopTournament,
      closeInscription: LolOrganizer.prototype.closeInscription,
      editText: LolOrganizer.prototype.editText,
      loadTournaments: LolOrganizer.prototype.loadTournaments,
    };
    ...
    return (
      <div id={`${game}-organaizer-main-wrapper`} className='main-wrapper'>
        {htmlTemplates.classicTemplate(
          ...
          LolOrganizer.prototype.tInfoPacketFunctions,
          LolOrganizer.prototype.uploadInstances,
          LolOrganizer.prototype.selectInit,
          LolOrganizer.prototype.organizerPanel,
          LolOrganizer.prototype.orgForm,
          LolOrganizer.prototype.eraseTournament
        )}
      </div>
    );
  }
