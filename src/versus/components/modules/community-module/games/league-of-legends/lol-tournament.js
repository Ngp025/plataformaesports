...
// Local SCSS imports
import '../../../../../styles/games/league-of-legends/lol-tournament.scss';
...
class LolTournament extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tInfo: {
      ...
      interval: setInterval(function tCheck() {
        LolTournament.prototype.timeDataCheck();
      }, 1000),
    ...
    LolTournament.prototype.timeDataCheck = LolTournament.prototype.timeDataCheck.bind(
      this
    );
    LolTournament.prototype.supportNavHandler = LolTournament.prototype.supportNavHandler.bind(
      this
    );
  }
    ...
    if (!this.state.tInfo) {
      ...
      if (this.state.tInfo.tStart === 'cargando') {
        ...
        organizerClock.tournamentClock(
          ...
          LolTournament.prototype.clockOutput
        );
      }
    }
  }
    ...
    return (
      <div id={`${game}-tournament-main-wrapper`}>
        {htmlTemplates.classicTemplate(
          ...
          LolTournament.prototype.supportNavHandler,
