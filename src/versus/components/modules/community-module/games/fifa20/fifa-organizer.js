...
var isEditing = false;
// SCSS imports
import '../../../../../styles/games/fifa20/fifa-organizer.scss';
...
class FifaOrganizer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // Admin validation
    ...
    FifaOrganizer.prototype.uploadInstances = FifaOrganizer.prototype.uploadInstances.bind(
      this
    );
    FifaOrganizer.prototype.eraseTournament = FifaOrganizer.prototype.eraseTournament.bind(
      this
    );
    FifaOrganizer.prototype.organizerPanel = FifaOrganizer.prototype.organizerPanel.bind(
      this
    );
    FifaOrganizer.prototype.editTournament = FifaOrganizer.prototype.editTournament.bind(
      this
    );
    FifaOrganizer.prototype.navigationHandler = FifaOrganizer.prototype.navigationHandler.bind(
      this
    );
    FifaOrganizer.prototype.organizerButtonsHandler = FifaOrganizer.prototype.organizerButtonsHandler.bind(
      this
    );
    FifaOrganizer.prototype.orgForm = FifaOrganizer.prototype.orgForm.bind(
      this
    );
    FifaOrganizer.prototype.saveSingleInstance = FifaOrganizer.prototype.saveSingleInstance.bind(
      this
    );
    FifaOrganizer.prototype.unassignedDays = FifaOrganizer.prototype.unassignedDays.bind(
      this
    );
    FifaOrganizer.prototype.assignedDays = FifaOrganizer.prototype.assignedDays.bind(
      this
    );
    FifaOrganizer.prototype.updateClickedDay = FifaOrganizer.prototype.updateClickedDay.bind(
      this
    );
    FifaOrganizer.prototype.loadTournaments = FifaOrganizer.prototype.loadTournaments.bind(
      this
    );
  }
    ...
    if (initialDay > 0 && initialMonthNumber > 0 && weeksDuration > 0) {
      ...
      function customDay(dayInfo) {
        ...
        panelButton.addEventListener('click', () => {
          FifaOrganizer.prototype.organizerButtonsHandler(dayInfo.day, dayInfo);
        });
      ...
      function createDayButton(i, month) {
        ...
        panelButton.addEventListener('click', () =>
          FifaOrganizer.prototype.organizerButtonsHandler(
            completeDate,
            emptyData
          )
        );
  ...
  orgForm() {
    //FifaOrganizer.prototype.refreshFormPanel();
    // Local Vars
    ...
    function content(selectInit, updatingInstance) {
      ...
      function selectInstances(clickedInstance) {
        ...
        dayInstanceDiv.onchange = () => {
          FifaOrganizer.prototype.relatedDayRender();
        };
      ...
      //tStartInput.onChange = ()=> {FifaOrganizer.prototype.updatingInstance()}
      ...
      return (
        <button
          ...
          onClick={() => FifaOrganizer.prototype.saveSingleInstance(invoked)}>
          SAVEE
        </button>
      );
    }
  ...
  organizerButtonsHandler(dayData, nameDayInfo) {
    ...
    if (isUpdating()) {
      ...
      FifaOrganizer.prototype.saveSingleInstance(autoSave);
    }
  }
    ...
    switch (invoked.invoked) {
      case 'autoSave': {
        if (invoked.confirmed) {
          ...
          setTimeout(function () {
            FifaOrganizer.prototype.updateClickedDay(invoked.nameDayObj);
          }, 15);
        } else {
          setTimeout(function () {
            FifaOrganizer.prototype.updateClickedDay(invoked.nameDayObj);
  ...
  relatedDayRender() {
    ...
    FifaOrganizer.prototype.unassignedDays(event.target.value);
      ...
      if (unassignedDayPanelChilds[0]) {
        ...
        for (var i = 0; i < instanceArr.length; i++) {
          ...
          if (instanceArr[i].nextInstance[0]) {
            ...
            renderCheck
              ? renderDay(FifaOrganizer.prototype.relatedDayHandler)
              : '';
          }
        }
      }
  ...
  updateClickedDay(dayInfoObj) {
    FifaOrganizer.prototype.refreshButtonPanel();
    this.setState({
      dayInfo: dayInfoObj,
      autoSave: true,
    });
  ...
  tInfoPacketFunctions() {
    var tInfoFunctions = {
      confirmEdit: FifaOrganizer.prototype.confirmEdit,
      editTournament: FifaOrganizer.prototype.editTournament,
      eraseTournament: FifaOrganizer.prototype.eraseTournament,
      startTournament: FifaOrganizer.prototype.startTournament,
      stopTournament: FifaOrganizer.prototype.stopTournament,
      closeInscription: FifaOrganizer.prototype.closeInscription,
      editText: FifaOrganizer.prototype.editText,
      loadTournaments: FifaOrganizer.prototype.loadTournaments,
    };
    ...
    return (
      <div id={`${game}-organaizer-main-wrapper`} className='main-wrapper'>
        {htmlTemplates.classicTemplate(
          ...
          FifaOrganizer.prototype.tInfoPacketFunctions,
          FifaOrganizer.prototype.uploadInstances,
          FifaOrganizer.prototype.selectInit,
          FifaOrganizer.prototype.organizerPanel,
          FifaOrganizer.prototype.orgForm,
          FifaOrganizer.prototype.eraseTournament
        )}
      </div>
    );
  }
