...
//Styles
import '../../../styles/games/fifa20/fifa-playLanding.scss';
...
class FifaPlaylanding extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <div id={`${game}-playLanding-main-wrapper`}>
...
export default FifaPlaylanding;
