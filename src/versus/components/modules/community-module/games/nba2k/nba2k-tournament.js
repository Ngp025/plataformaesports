...
// Local SCSS imports
import '../../../../../styles/games/nba2k/nba2k-tournament.scss';
...
class NbaTournament extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tInfo: {
      ...
      interval: setInterval(function tCheck() {
        NbaTournament.prototype.timeDataCheck();
      }, 1000),
    ...
    NbaTournament.prototype.timeDataCheck = NbaTournament.prototype.timeDataCheck.bind(
      this
    );
    NbaTournament.prototype.supportNavHandler = NbaTournament.prototype.supportNavHandler.bind(
      this
    );
  }
    ...
    return (
      <div id={`${game}-tournament-main-wrapper`}>
        {htmlTemplates.classicTemplate(
          ...
          NbaTournament.prototype.supportNavHandler,
