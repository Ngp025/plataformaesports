...
// SCSS imports
import '../../../styles/customers/rosariojuega.scss';
// Logim
import login from '../../user/login/loginFunctions.js';
import '../../../styles/main/user/loguinModal.scss';

// Local Declarations
var customer = 'ROSARIO';
var gameClicked = [];
var gameIDTs = [];

class RosarioJuega extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  openLogin(validating) {
    if (validating) {
      RosarioJuega.prototype.loginState('validation');
    }
    if (event.target) {
      gameClicked.pop();
      gameIDTs.pop();
  ...
  async locallogin() {
    ...
    // LOCAL FUNCTION
    async function localLoginReload(json, send) {
    ...
    //Form Vars
    if (emailL && passwordL) {
      RosarioJuega.prototype.loginState('updating');
      //RosarioJuega.prototype.loginState('updating');
      await fetch(`users/betalogin/${emailL}/${passwordL}`)
        .then((res) => res.json())
        .then((json) => {
          if (json.alert) {
            RosarioJuega.prototype.loginState('login', true);
            alert(json.alert);
          } else {
            //RosarioJuega.prototype.loginState('congrats');
  ...
  localRegister() {
    ...
    function localLoginReload(json, send) {
      ...
      sessionStorage.setItem('userSession', json.send);
      localStorage.setItem('userData', JSON.stringify(json.send));
      send ? RosarioJuega.prototype.loginState('validation') : location.reload();
    }
  ...
  async gameModalHandler() {
    ...
    var RosarioJuegaContent = document.getElementById('RosarioJuega-box');
    var mainLogo = document.getElementById(
      'logo-align'
    )
    var closeModal = document.getElementById('close-login-modal')
      closeModal.addEventListener('click', ()=>{
      RosarioJuegaContent.style.opacity = 1;
      mainLogo.style.opacity = 1;
    })
    if (instance.isOpen === false) {
      //console.log('AQUI')
      instance.open();
      RosarioJuegaContent.style.opacity = 0.2;
    ...
    document.addEventListener('keydown', (key) => {
      if (key.key === 'Escape') {
        instance.isOpen === false
          ? (RosarioJuegaContent.style.opacity = 1, mainLogo.style.opacity = 1)
          : '';
      }
    });
  }
  ...
  startVideo() {
    ...
    if (videoContent.style.display === 'none') {
      ...
      setTimeout(() => this.gameModalHandler(), 35000);
      setTimeout(() => (videoContent.style.display = 'none'), 35000);
    } else {
  ...
  componentDidMount() {
    ...
    document.addEventListener('keydown', () => {
      if (event.code === 'Escape') {
        var RosarioJuegaContent = document.getElementById('RosarioJuega-box');
        var modalOverlay = document.getElementsByClassName('modal-overlay');
        //console.log(RosarioJuegaContent)
        if (RosarioJuegaContent.style.display === 'none') {
          this.gameModalHandler();
          RosarioJuegaContent.style.display = 'block';
          //console.log(RosarioJuegaContent)
        }
      }
    });
  ...
  render() {
    return (
      <div id='responsive-RosarioJuega'>
        <div
          id='RosarioJuega-wrapper-image'
          className='RosarioJuega-wrapper-image'></div>
        <div
          id='RosarioJuega-wrapper-gradient'
          className='RosarioJuega-wrapper-gradient'></div>
        <div
          id='plataformaesports-RosarioJuega'
          className='RosarioJuega-wrapper'>
          <div id='RosarioJuega-content' className='RosarioJuega-content'>
            ...
            {gamesModal(
              ...
              RosarioJuega.prototype.openLogin
            )}
            <div id='logo-align' className='logo-align'>
              <img
                id='vs-logo'
                className='vs-logo'
                onClick={()=> { location.href = 'https://instagram.com/juventudesrosario?igshid=nrpl5pceitxk'}}
                alt='Municipalidad-Rosario'
                src='https://res.cloudinary.com/versus/image/upload/v1599085834/Statics_images/Customers%20Sponsors/Rosario/ezfny8jnpusulniqhmlq.png'
              />
            </div>
            ...
            <div id='RosarioJuega-box'>
              <h4 id='RosarioJuega-legend' className='RosarioJuega-legend'>
              ...
              <div
                ...
                <div id='video-align' className='video-align'>
                  ...
                  <video
                    ...
                    src='https://res.cloudinary.com/versus/video/upload/v1599086772/Videos/ROSARIO/kmjcxromcdsvx5mcjytl.mp4'
                    type='video/mp4'
                  />
                </div>
              </div>
            ...
            <div id='sponsor-footer-1' className='sponsor-footer-prod'>
              <img
                id='sponsor-1'
                onClick={()=> window.open('https://www.instagram.com/esportslandarg/?hl=es-la')}
                className='sponsor-img animatedO opacity'
                src='https://res.cloudinary.com/versus/image/upload/v1600271006/Customers/cbb2mo2tjzwinu2qbmxx.png'></img>
            </div> */}
            ...
            <div id='sponsor-footer' className='sponsor-footer'>
              <img
                id='sponsor-2'
                onClick={()=> window.open('https://www.instagram.com/libreopcion/?hl=es-la')}
            ...
            <p title='Sponsors' id='text-sponsor-3' className='text-sponsor'>
              CO-Organiza
            </p>
            <div id='sponsor-footer-3' className='sponsor-footer'>
              <img
                id='sponsor-1'
                onClick = {()=>{window.open('https://instagram.com/educacionfisicaunr?igshid=xz7yeq1gnsg2')}}
                className='unr animatedO opacity'
                src='https://res.cloudinary.com/versus/image/upload/v1599848542/Statics_images/Customers%20Sponsors/Rosario/dp53naghjows7hqiop8r.png'></img>
            </div>
            <div
              id='modal1'
              ...
              <div
                ...
                {login.loginBeta(
                  RosarioJuega.prototype.loginState,
                  this.locallogin,
                  this.state.personalize !== 'load'
                ...
                {login.validationModal(
                  RosarioJuega.prototype.localValidation,
                  this.state.personalize !== 'load'
                    ? this.state.personalize.mainColor
                    : 0
                )}
                ...
                <i
                  ...
                  onClick={() => RosarioJuega.prototype.loginState('login')}>
                  arrow_back
                </i>
              </div>
            </div>
